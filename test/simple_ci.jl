...
function f()
    ...
    @testset "simple hf " begin
        ...
        energy, vals_up, vals_dn, vects_up, vects_dn, rho, H_HF, Hup, Hdn = ConfigurationInteraction.HartreeFock.solveHF(H_HF);
        H_ci = ConfigurationInteraction.CI.construct_ham(H_HF, vals_up, vals_dn, vects_up, vects_dn, 2);
        ...
        @test vals_ed[1] ≈ -3.998083843408522

        H_HF = ConfigurationInteraction.HartreeFock.makeHF(4,2, 2, t = t,  U = U);
        energy, vals_up, vals_dn, vects_up, vects_dn, rho, H_HF, Hup, Hdn = ConfigurationInteraction.HartreeFock.solveHF(H_HF);
        H_ci = ConfigurationInteraction.CI.construct_ham(H_HF, vals_up, vals_dn, vects_up, vects_dn, 4);
        vals_ci = eigvals(H_ci)
